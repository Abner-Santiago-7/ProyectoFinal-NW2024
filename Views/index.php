    ...
    <div id="my_slider" class="carousel slide" data-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <div class="row">
            <div class="col-sm-12">
              <h1 class="banner_taital">Descubre <br>Tu Tienda Ideal</h1>
        ...
        <div class="carousel-item">
          <div class="row">
            <div class="col-sm-12">
            <h1 class="banner_taital">Encuentra <br>Todo en un Solo Lugar</h1>
            <div class="buynow_bt"><a href="#">Comprar ahora</a></div>
            </div>
          </div>
        </div>
        <div class="carousel-item">
          <div class="row">
            <div class="col-sm-12">
            <h1 class="banner_taital">Comienza <br>Tu Experiencia de Compra</h1>
            <div class="buynow_bt"><a href="#">Comprar ahora</a></div>
            </div>
          </div>
        </div>
