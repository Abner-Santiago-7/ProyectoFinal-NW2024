...
<div class="copyright_section">
  <div class="container">
    <p class="copyright_text">© Proyecto Final-NW <?php echo date('Y'); ?> <a href="#"></a></p>
  </div>
</div>
        ...
        <div class="row">
          <div class="col-md-12" id="frmLogin">
            <div class="form-group mb-3">
              ...
              <input id="correoLogin" class="form-control" type="email" name="correoLogin" placeholder="Correo Electrónico" required>
            </div>
            <div class="form-group mb-3">
              <label for="claveLogin"><i class="fas fa-key"></i> Contraseña</label>
              <input id="claveLogin" class="form-control" type="password" name="claveLogin" placeholder="Contraseña" required>
            </div>
          ...
          <div class="col-md-12 d-none" id="frmRegister">
            <div class="form-group mb-3">
              ...
              <input id="nombreRegistro" class="form-control" type="text" name="nombreRegistro" placeholder="Nombre Completo" required>
            </div>
            <div class="form-group mb-3">
